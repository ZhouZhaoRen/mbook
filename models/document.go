...
type Document struct {
	...
	Identify     string        `orm:"column(identify);size(100);index;null;default(null)" json:"identify"` // 标识
	...
	Release      string        `orm:"column(release);type(text);null" json:"release"`  // 发布后的HTML
